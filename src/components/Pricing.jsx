  ...
  const programs = [
    {
      ...
      description: 'Build tools and products that will be used every day by millions of people.',
    ...
    },
    {
      ...
      description: 'Use accessible tools to make data useful and insightful. Become indispensable without having to code.',
      image: '/api/placeholder/250/180',
      monthlyPrice: 235,
      upfrontSavings: 3190,
      hasInstallments: true,
    ...
    },
    {
      ...
      description: 'Break software and document the results, without knowing code.',
      image: '/api/placeholder/250/180',
      monthlyPrice: 190,
      upfrontSavings: 1590,
      hasInstallments: true,
    ...
    },
    {
      ...
      description: 'Protect people, organizations, networks, and data from security breaches and online threats.',
      image: '/api/placeholder/250/180',
      monthlyPrice: 240,
      upfrontSavings: 3170,
      hasInstallments: true,
    ...
    },
    {
      ...
      duration: '8 months',
      title: 'Data Science',
      description: 'Train AI/ML models, turn raw data into predictions. No CS/STEM background required—we cover basic stats and Python.',
      image: '/api/placeholder/250/180',
      monthlyPrice: 240,
      upfrontSavings: 3170,
      hasInstallments: true,
    ...
    },
    {
      ...
      duration: '5 months',
      title: 'UX/UI Design',
      description: 'UX/UI Designers design apps, websites, and enterprise software so that theyre easier to use by more people.',
      image: '/api/placeholder/250/180',
      monthlyPrice: 190,
      upfrontSavings: 1590,
      hasInstallments: true,
      ...
      <div className="container">
        ...
        <div className="pricing-header">
          <h2 className="pricing-title">
            ...
            <br />into tech—only at FES.
            <br /><span className="pricing-highlight">From $200/month</span>
          </h2>
          <p className="pricing-subtitle">
            We offer payment options for every situation, as well as a
            <br />risk-free trial period and money-back guarantee
          </p>
        </div>
                ...
                {program.hasInstallments && (
                  <div className="tuition-option">
                    ...
                    <span className="option-text">
                      Installments with FES from ${program.monthlyPrice}/mo. No credit check, 0% interest, preapproved
                    </span>
                  </div>
                )}
        ...
        <div className="awards-section">
          ...
          <div className="review-score">
            ...
            <p className="review-subtitle">
              Check us out on <a href="#career-karma">Career Karma</a>, <a href="#switchup">SwitchUp</a>, 
              and <a href="#course-report">Course Report</a>
            </p>
          </div>
        </div>
      </div>
