    ...
    <div className="career">
      <div className="career__content">
        ...
        <div className="career__form-container">
          <h3 className="career__form-title">Reserve your spot and join us!</h3>
          ...
          <div className="career__form">
            ...
            <div className="career__checkbox-group">
              ...
              <label htmlFor="consent" className="career__checkbox-label">
                ...
                made with an autodialed or artificial voice messages. Message
                and data rates may apply. Unsubscribe anytime per our{" "}
