      ...
      <div className="container">
        ...
        <div className="guarantee-cards">
          ...
          <div className="guarantee-card">
            ...
            <h3 className="card-title">
              <span className="accent-text">Flexible</span> payment
              <br />
              options
            </h3>
            <ul className="payment-options-list">
              <li>
                <span className="bullet">•</span> Upfront to pay up to 30% less
              </li>
              <li>
                <span className="bullet">•</span> Installment plans
              </li>
              <li>
                <span className="bullet">•</span> Tuition financing
              </li>
            </ul>
            <a href="#" className="card-link">
        ...
        <div className="success-rate-section">
          <div className="graduate-images">
            ...
            <div className="grad-img img-1">
              <img
                src="	https://tripleten.com/usa-assets/usa-main/tild3365-3730-4632-b566-633730636538__ellipse_150_1.png"
                alt="Graduate"
              />
            </div>
            <div className="grad-img img-2">
              <img
                src="	https://tripleten.com/usa-assets/usa-main/tild3365-3730-4632-b566-633730636538__ellipse_150_1.png"
                alt="Graduate"
              />
            </div>
            <div className="grad-img img-3">
              <img
                src="	https://tripleten.com/usa-assets/usa-main/tild3365-3730-4632-b566-633730636538__ellipse_150_1.png"
                alt="Graduate"
              />
            </div>
            <div className="grad-img img-4">
              <img
                src="	https://tripleten.com/usa-assets/usa-main/tild3365-3730-4632-b566-633730636538__ellipse_150_1.png"
                alt="Graduate"
              />
            </div>
            <div className="grad-img img-5">
              <img
                src="	https://tripleten.com/usa-assets/usa-main/tild3365-3730-4632-b566-633730636538__ellipse_150_1.png"
                alt="Graduate"
              />
            </div>
            <div className="grad-img img-6">
              <img
                src="	https://tripleten.com/usa-assets/usa-main/tild3365-3730-4632-b566-633730636538__ellipse_150_1.png"
                alt="Graduate"
              />
            </div>
            <div className="grad-img img-7">
              <img
                src="	https://tripleten.com/usa-assets/usa-main/tild3365-3730-4632-b566-633730636538__ellipse_150_1.png"
                alt="Graduate"
              />
            </div>
            <div className="grad-img img-8">
              <img
                src="	https://tripleten.com/usa-assets/usa-main/tild3365-3730-4632-b566-633730636538__ellipse_150_1.png"
                alt="Graduate"
              />
            </div>
            <div className="grad-img img-9">
              <img
                src="	https://tripleten.com/usa-assets/usa-main/tild3365-3730-4632-b566-633730636538__ellipse_150_1.png"
                alt="Graduate"
              />
            </div>
            <div className="grad-img img-10">
              <img
                src="	https://tripleten.com/usa-assets/usa-main/tild3365-3730-4632-b566-633730636538__ellipse_150_1.png"
                alt="Graduate"
              />
          ...
          <div className="success-content">
            ...
            <p className="success-description">
              of our grads get hired within 6 months
              <br />
